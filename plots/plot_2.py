...
def plot_2():
    ...
    st.sidebar.header("Filter data for plot 2")
    ...
    # Line Chart
    st.title(
        "Civilian Employment vs. Civilian Unemployment: Tracking Workforce Dynamics:"
    )
    st.write(
    ...
    fig.update_yaxes(title_text="<b>Employment Numbers</b>", secondary_y=False)
    fig.update_layout(
